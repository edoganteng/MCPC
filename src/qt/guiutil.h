...
/** Utility functions used by the MCPCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MCPCoin addresses in monospace font
...
// Parse "MCPCoin:" URI into recipient object, return true on successful parsing
