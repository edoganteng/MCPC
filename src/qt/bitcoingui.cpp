                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MCPCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MCPCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MCPCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MCPCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MCPCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MCPCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MCPCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MCPCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MCPCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MCPCoin Core help message to get a list with possible MCPCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MCPCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MCPCoin network", "", count));
}
...
{
    QString strTitle = tr("MCPCoin Core"); // default title
