...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "MCPCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MCPCoin features */
        {"MCPCoin", "masternode", &masternode, true, true, false},
        {"MCPCoin", "listmasternodes", &listmasternodes, true, true, false},
        {"MCPCoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"MCPCoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"MCPCoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"MCPCoin", "masternodedebug", &masternodedebug, true, true, false},
        {"MCPCoin", "startmasternode", &startmasternode, true, true, false},
        {"MCPCoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"MCPCoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"MCPCoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"MCPCoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"MCPCoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"MCPCoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"MCPCoin", "mnbudget", &mnbudget, true, true, false},
        {"MCPCoin", "preparebudget", &preparebudget, true, true, false},
        {"MCPCoin", "submitbudget", &submitbudget, true, true, false},
        {"MCPCoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"MCPCoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"MCPCoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"MCPCoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"MCPCoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"MCPCoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"MCPCoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"MCPCoin", "checkbudgets", &checkbudgets, true, true, false},
        {"MCPCoin", "mnsync", &mnsync, true, true, false},
        {"MCPCoin", "spork", &spork, true, true, false},
        {"MCPCoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"MCPCoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use MCPCoind, or the -server option to MCPCoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> MCPCoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:49452/\n";
}
