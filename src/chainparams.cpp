...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (159810,uint256("0df214dd14f023522da692dd49ec481ebbfee7c79002f2bb4869f652f994f2e9"))
    (1000000,uint256("0df214dd14f023522da692dd49ec481ebbfee7c79002f2bb4869f652f994f2e9"))
    (1505178,uint256("9860d52c9458e3d460718718eec4c13ca1967f44053214f1e3432397ab4e0835"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1635600897, // * UNIX timestamp of last checkpoint block
    1028745,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 49451;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // MCPCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // MCPCoin: 1 day
        nTargetSpacing = 1 * 60;  // MCPCoin: 1 minute
        nLastPOWBlock = 140;
        nMaturity = 59;
        ...
        nForkTimestamp = 1554026400;  // Sunday, 31 March 2019, 10:00:00 GMT/UTC
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "We will change the future of PoS coins! Note this down!! MobilePayCoin";
        ...
        vSeeds.push_back(CDNSSeedData("mcpc.io", "seeds.seeder01.mcpc.io"));
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet MCPCoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet MCPCoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet MCPCoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet MCPCoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet MCPCoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // MCPCoin: 1 day
        nTargetSpacing = 1 * 60;        // MCPCoin: 1 minutes
