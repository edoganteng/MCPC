/* src/config/MCPCoin-config.h.  Generated from MCPCoin-config.h.in by configure.  */
/* src/config/MCPCoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MCPC_CONFIG_H

#define MCPC_CONFIG_H
...
#define PACKAGE_NAME "MCPCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MCPCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "MCPCoin"
