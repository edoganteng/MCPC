...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MCPCoin Core MCPCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  MCPCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MCPCoin transaction") + "\n" +
                               "  MCPCoin-tx [options] -create [commands]   " + _("Create hex-encoded MCPCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MCPCoin transaction
