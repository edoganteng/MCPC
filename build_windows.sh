...
# Create zip file of binaries
	cp MCPC/src/MCPCoind.exe MCPC/src/MCPCoin-cli.exe MCPC/src/MCPCoin-tx.exe MCPC/src/qt/MCPCoin-qt.exe .
	zip MCPC-Windows.zip MCPCoind.exe MCPCoin-cli.exe MCPCoin-tx.exe MCPCoin-qt.exe
	rm -f MCPCoind.exe MCPCoin-cli.exe MCPCoin-tx.exe MCPCoin-qt.exe