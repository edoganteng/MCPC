...
In order to support loading of multiple wallets in MCPCoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is MCPCoin.cpp.
...
Changes to MCPCoin.cpp
----------------------
MCPCoin.cpp is the entry point into MCPCoin-qt, and as such, will require some minor modifications to provide hooks for
