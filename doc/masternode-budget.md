...
MCPCoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<MCPCoin_address\> \<monthly_payment_MCPCoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ MCPCoin, _12_ times over the course of a year totaling _24000_ MCPCoin.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<MCPCoin_address\> \<monthly_payment_MCPCoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` MCPCoin.
 ...
 * vote-many          - Vote on a MCPCoin initiative
 * vote-alias         - Vote on a MCPCoin initiative
 * vote               - Vote on a MCPCoin initiative/budget
