...
This mechanism has been integrated into Bitcore-Node-MCPCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MCPCoin-Project/insight-api-MCPCoin#web-socket-api](https://github.com/MCPCoin-Project/insight-api-MCPCoin#web-socket-api) 
* API: [https://github.com/MCPCoin-Project/insight-api-MCPCoin#swifttx-transactions](https://github.com/MCPCoin-Project/insight-api-MCPCoin#swifttx-transactions) 
...
By default, the MCPCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MCPCoin Core daemon:
