...
# Create zip file of binaries
	cp MCPC/src/MCPCoind MCPC/src/MCPCoin-cli MCPC/src/MCPCoin-tx MCPC/src/qt/MCPCoin-qt .
	zip MCPC-Linux.zip MCPCoind MCPCoin-cli MCPCoin-tx MCPCoin-qt
	rm -f MCPCoind MCPCoin-cli MCPCoin-tx MCPCoin-qt